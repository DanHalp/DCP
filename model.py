...
class MLPHead(nn.Module):
    def __init__(self, args):
        ...
        emb_dims = args.TRANSFORM.emb_dims
...
class Transformer(nn.Module):
    def __init__(self, args):
        ...
        self.N = args.TRANSFORM.n_blocks
        self.dropout = args.TRANSFORM.dropout
        self.ff_dims = args.TRANSFORM.ff_dims
        self.n_heads = args.TRANSFORM.n_heads
        c = copy.deepcopy
...
class DCP(nn.Module):
    def __init__(self, args):
        ...
        elif args.TRANSFORM.emb_nn == 'dgcnn':
            self.emb_nn = DGCNN(emb_dims=self.emb_dims)
        else:
            raise Exception('Not implemented')

        if args.TRANSFORM.pointer == 'identity':
            self.pointer = Identity()
        elif args.TRANSFORM.pointer == 'transformer':
            self.pointer = Transformer(args=args)
        else:
            raise Exception("Not implemented")

        if args.TRANSFORM.head == 'mlp':
            self.head = MLPHead(args=args)
        elif args.TRANSFORM.head == 'svd':
